...
const SuperQuality = () => {
  return (
    ...
    <h2 className="font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
      ...
      <p className="mt-6 lg:max-w-lg info-text">Our dedication to deatil and excellence ensures your satisfaction</p>
      ...
      <div className="flex-1 flex justify-ceny-ter items-center">
        <img src={shoe8} 
        alt="shoe8"
        width={570}
        height={570}
